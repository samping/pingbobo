...
import com.tx.hsp.pingbobo.fragment.FragmentHome;
import com.tx.hsp.pingbobo.fragment.FragmentNavigationDrawer;

public class ActivityHome extends ActionBarActivity
        implements FragmentNavigationDrawer.NavigationDrawerCallbacks ,FragmentHome.OnFragmentInteractionListener{
...
//                .commit();
        fragmentManager.beginTransaction()
                .replace(R.id.container, FragmentHome.newInstance(MyApplication.getOauth()))
                .commit();
    }
